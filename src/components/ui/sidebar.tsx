...
type SidebarContextProps = {
  ...
  currentPanelId: PanelIdentifier;
  open: boolean;
  setPanel: (newPanel: PanelIdentifier) => void;
...
function SidebarProvider({
  defaultOpen = true,
  open: openProp,
  currentPanelId: currentPanelIdProp,
  ...
  const [currentPanelId, setCurrentPanelId] =
    React.useState<PanelIdentifier>(currentPanelIdProp);
